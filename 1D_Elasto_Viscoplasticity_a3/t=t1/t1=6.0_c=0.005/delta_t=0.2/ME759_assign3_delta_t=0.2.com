...
options = {
    ...
    'importer':OFF,
    'importerParts':OFF,
    'includes':['DispAmp.csv'],
    'initialConditionsFile':OFF,
    'input':'ME759_assign3_delta_t=0.2',
    'inputFormat':INP,
    'job':'ME759_assign3_delta_t=0.2',
    'keyword_licenses':[],
    'lanczos':OFF,
    'libs':[],
    'magnetostatic':OFF,
    ...
    'tracer':OFF,
    'unsymm':OFF,
    'user':'D:\\MTechDesign\\Sem4\\ME759_NonlinearFEM\\Codes\\Assignment3\\Elasto-Viscoplasticity_1D.for',
    'visco':OFF,
    'xplSelect':OFF,
}
